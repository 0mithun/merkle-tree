...
function buildMerkleTree(transactions) {
    ...
    while (leaves.length > 1) {
        ...
        for (let i = 0; i < leaves.length; i += 2) {
            const left = leaves[i];
            const right = (i + 1 < leaves.length) ? leaves[i + 1] : left; // Handle odd number of leaves by duplicating the last one
...
const json = JSON.stringify(merkleTree, null,  2);

fs.writeFileSync('merkleRoot2.json', json);

console.log(sha256('6a0e8850a8be8818cfc1be924c45090731068f4028815bec335d237046e9d474' + '6a0e8850a8be8818cfc1be924c45090731068f4028815bec335d237046e9d474'));